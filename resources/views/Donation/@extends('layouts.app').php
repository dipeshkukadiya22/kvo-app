                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                  <div class="d-inline-block">
                                                    ...
                                                    data-bs-target="#offcanvasBackdrop" aria-controls="offcanvasBackdrop"><img src="./assets/icon/orange-edit.png" width="20px"></a>
                                                    @php
                                                    if(session('role')=="ADMIN"){ @endphp
                                                        <a class="text-danger delete-record"><img src="./assets/icon/orange-trash.png" width="20px"></a>
                                                    @php } @endphp
