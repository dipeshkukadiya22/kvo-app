...
@section('title', 'Booked Room Report')
                    ...
                    <div class="content-header row">
                      <div class="content-header-left col-md-9 col-12 mb-2">
                        {{-- <div class="row breadcrumbs-top">
                          <div class="col-12">
                            <h4 class="fw-bold py-3">Booked Room Report</h4>
                          </div>
                        </div> --}}
                      </div>
                    </div>
                        ...
                        <div class="col-md mb-4 mb-md-0">
                          <div class="card">
                            ...
                            <div class="col-md mb-4 mb-md-0">
                                <div class="card">
                                <div class="card-body">
                                    <form id="kvo_medical_report" method="GET" class="browser-default-validation" action="{{route('show_room_booking_report')}}">
                                        <div class="row g-3">
                                            ...
                                            <div class="card-datatable pt-0">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="font-size:15px"><b>Room List</b></th>
