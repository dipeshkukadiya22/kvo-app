...
class pdfcontroller extends Controller
{
    ...
    public function pdf_CheckIn($id)
    {
        ...
        $no_of_member=DB::SELECT("SELECT count(*) from member_details WHERE room_id='$id'");
        $pdf = Pdf::loadView('pdf.pdf_Checkin',['room_booking'=>$room_booking,'member_detail'=>$member_detail,'no_of-member'=>$no_of_member])->setPaper('a4', 'potrait')->setOptions(['defaultFont' => 'NotoSansGujarati-Regular','enable_remote', TRUE]);
        return $pdf->stream();
    }
}
